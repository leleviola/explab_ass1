...
def marker_callback(msg):
    global current_marker_index, float_array, last_marker_id, list_complete,lower_marker_id
    if msg.marker_ids[0] not in markers:
        float_array.data = [0.5]
...
def main(args=None):
    ...
    publisher = node.create_publisher(Float64MultiArray, '/camera_joint_controller/commands', 10)
